...
st.set_page_config(page_title="待辦2｜菜單儀表板", layout="wide")
user = require_page("待辦2")
log_access(user, "待辦2")
apply_base_css()
...
with h1:
    st.markdown(
        f'<div class="page-title">待辦2</div>'
        f'<div class="page-subtitle">{today_str} &nbsp;·&nbsp; {user_short} &nbsp;·&nbsp; 待辦2</div>',
        unsafe_allow_html=True,
    )
with h2:
...
tasks_all = todo_list(
    ...
    include_done=True,
    sort=sort,
    current_user=user, namespace="todo2",
)
