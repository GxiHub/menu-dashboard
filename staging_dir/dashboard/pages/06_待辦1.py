...
st.set_page_config(page_title="待辦1｜菜單儀表板", layout="wide")
user = require_page("待辦1")
log_access(user, "待辦1")
apply_base_css()
...
with h1:
    st.markdown(
        f'<div class="page-title">待辦1</div>'
        f'<div class="page-subtitle">{today_str} &nbsp;·&nbsp; {user_short} &nbsp;·&nbsp; 待辦1</div>',
        unsafe_allow_html=True,
    )
with h2:
...
tasks_all = todo_list(
    ...
    include_done=True,
    sort=sort,
    current_user=user, namespace="public",
)
