...
st.set_page_config(page_title="待辦3｜菜單儀表板", layout="wide")
user = require_page("待辦3")
log_access(user, "待辦3")
apply_base_css()
...
with h1:
    st.markdown(
        f'<div class="page-title">待辦3</div>'
        f'<div class="page-subtitle">{today_str} &nbsp;·&nbsp; {user_short} &nbsp;·&nbsp; 待辦3</div>',
        unsafe_allow_html=True,
    )
with h2:
...
tasks_all = todo_list(
    ...
    include_done=True,
    sort=sort,
    current_user=user, namespace="todo3",
)
